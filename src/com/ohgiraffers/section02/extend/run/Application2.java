...
public class Application2 {
    public static void main(String[] args) {
        ...
        * */
        ...
        //wildCardFarm.extendsanyType(new RabbitFarm<>(new Rabbit()));
        wildCardFarm.extendsanyType(new RabbitFarm<>(new Bunny()));
        wildCardFarm.extendsanyType(new RabbitFarm<>(new DrunkenBunny()));
